...
const Carousel: React.FunctionComponent<Props> = props => {
  ...
  return <div className={classes(sc(''), className)} onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
    <div className={sc('view', `${animation}`, `${direction}`)} {...rest} ref={viewRef}>{renderCarsouselItem()}</div>
